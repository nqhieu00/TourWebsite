    ...
    <div class="container">
        <form method="POST">
            <div class="form-group">
                ...
                <div class="col-sm-12" style="  margin-bottom:20px"> <input type="date" class="form-control"
                ...
                <label for="name" class="col-sm-12">ID vùng(bắc-1; trung-2;nam-3): </label>
                <div class="col-sm-12" style="  margin-bottom:20px"> <input type="text" class="form-control"
                        name="IDVungMien" value="<?php echo $row['IDVungMien']; ?>"></div>
                ...
                <div class="col-sm-12" style="  margin-bottom:20px">
                    <textarea class="form-control form-control-sm mb-3" rows="3" name="CTLichTrinh"
                         > <?php echo $row2['LichTrinh'] ?> </textarea>
                </div>

                <label for="name" class="col-sm-12">Ghi Chú: </label>
                <div class="col-sm-12" style="  margin-bottom:20px">
                    <textarea class="form-control form-control-sm mb-3" rows="3" name="GhiChu"
                     > <?php echo $row2['GhiChu'] ?>  </textarea>
                </div>

                <label for="name" class="col-sm-12">Dịch vụ:</label>
                <div class="col-sm-12" style="  margin-bottom:20px">
                    <textarea class="form-control form-control-sm mb-3" rows="3" name="DichVu"
                       ><?php echo $row2['DichVu'] ?></textarea>
                </div>
                <label for="name" class="col-sm-12">Mô tả chuyến đi:</label>
                <div class="col-sm-12" style="  margin-bottom:20px">
                    <textarea class="form-control form-control-sm mb-3" rows="3" name="Text"
                       ><?php echo $row2['Text'] ?></textarea>

                </div>
                <div class="col-sm-12" style="text-align:center">
                        <input type="submit" class="btn btn-primary col-sm-6" name="submit" value="Update tour">
                        <button class="btn btn-primary col-sm-6"><a href="?Page_layout=delete_tour&IDTour=<?php echo $row['IDTour'] ?>">Delete Tour</a></button> 
                </div>
